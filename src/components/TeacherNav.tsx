...
export default function TeacherNav({ activePage }: { activePage?: TeacherPage }) {
  ...
  useEffect(() => { setShowMobileMenu(false) }, [activePage])
  ...
  const mobileLink = (page: TeacherPage) =>
    ...
    <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      ...
      {showMobileMenu && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-700 px-3 py-3 space-y-0.5">
          <Link to="/teacher/grades" className={mobileLink('grades')} onClick={() => setShowMobileMenu(false)}>Grade Tracker</Link>
          <Link to="/messages" className={mobileLink('messages')} onClick={() => setShowMobileMenu(false)}>Messages</Link>
          <Link to="/teacher/rubrics" className={mobileLink('rubrics')} onClick={() => setShowMobileMenu(false)}>Rubrics</Link>
          <Link to="/teacher/assignments" className={mobileLink('assignments')} onClick={() => setShowMobileMenu(false)}>Assignments</Link>
          <Link to="/teacher/calendar" className={mobileLink('calendar')} onClick={() => setShowMobileMenu(false)}>Calendar</Link>
          <Link to="/teacher/settings" className={mobileLink('settings')} onClick={() => setShowMobileMenu(false)}>Settings</Link>
          <div className="pt-1 border-t border-gray-100 dark:border-gray-700">
            <p className="px-4 py-1.5 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Tools</p>
            <Link to="/teacher/rankings" className={mobileLink('rankings')} onClick={() => setShowMobileMenu(false)}>Rankings</Link>
            <Link to="/teacher/templates" className={mobileLink('templates')} onClick={() => setShowMobileMenu(false)}>Templates</Link>
            <Link to="/teacher/planner" className={mobileLink('planner')} onClick={() => setShowMobileMenu(false)}>Lesson Planner</Link>
            <Link to="/teacher/interventions" className={mobileLink('interventions')} onClick={() => setShowMobileMenu(false)}>Interventions</Link>
            <Link to="/teacher/announcements" className={mobileLink('announcements')} onClick={() => setShowMobileMenu(false)}>Announcements</Link>
          </div>
