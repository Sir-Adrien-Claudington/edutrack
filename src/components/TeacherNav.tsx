    ...
    <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        {activePage && activePage !== 'dashboard' ? (
          <Link
            to="/teacher"
            className="flex items-center gap-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
          >
            <svg
          ...
          <Link
            to="/teacher"
            className="text-lg font-semibold text-indigo-700 dark:text-indigo-400"
          >
            EduTrack
          </Link>
        )}
        ...
        <div className="md:hidden border-t border-gray-200 dark:border-gray-700 px-3 py-3 space-y-0.5">
          ...
          <div className="pt-1 border-t border-gray-100 dark:border-gray-700">
            ...
            <Link
              ...
              className={mobileLink('templates')}
              onClick={() => setShowMobileMenu(false)}
            >
              Templates
            </Link>
            ...
            <Link
              ...
              className={mobileLink('interventions')}
              onClick={() => setShowMobileMenu(false)}
            >
              Interventions
            </Link>
            <Link
              ...
              className={mobileLink('announcements')}
              onClick={() => setShowMobileMenu(false)}
            >
              Announcements
            </Link>
