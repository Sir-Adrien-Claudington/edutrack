        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Your teacher will assign work once you join a class
            </p>
          </div>
        ) : (
                  ...
                  {done.map((a) => {
                    ...
                    return (
                      <Link
                        key={a.id}
                        to={dest}
                        className="block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-5 py-4 opacity-75 hover:opacity-100 hover:border-teal-300 hover:shadow-sm transition-all"
                      >
                        <div className="flex items-start justify-between">
                          <div>
                            <h3 className="font-medium text-gray-900 dark:text-white">{a.title}</h3>
