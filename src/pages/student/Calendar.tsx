...
export default function StudentCalendar() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <StudentNav activePage="calendar" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          ...
          <div className="grid grid-cols-7">
            {DAY_NAMES.map((d) => (
              <div
                key={d}
                className="py-2 text-center text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide"
              >
                {d}
              </div>
            ))}
            {cells.map((day, i) => {
              if (!day)
                return (
                  <div key={i} className="h-16 border-t border-gray-100 dark:border-gray-700/50" />
                )
              ...
              return (
                ...
                >
                  <span
                    className={`w-6 h-6 flex items-center justify-center text-sm rounded-full leading-none font-medium ${todayDay ? 'bg-teal-600 text-white' : 'text-gray-700 dark:text-gray-300'}`}
                  >
                    {day}
                  </span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Sync your assignment due dates to Google Calendar.
            </p>
          </div>
