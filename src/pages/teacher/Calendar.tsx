          ...
          <div className="grid grid-cols-7">
            ...
            {cells.map((day, i) => {
              ...
              return (
                ...
                >
                  <span
                    className={`w-6 h-6 flex items-center justify-center text-sm rounded-full leading-none font-medium ${todayDay ? 'bg-indigo-600 text-white' : 'text-gray-700 dark:text-gray-300'}`}
                  >
                    {day}
                  </span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Sync assignment due dates to your Google Calendar.
            </p>
          </div>
