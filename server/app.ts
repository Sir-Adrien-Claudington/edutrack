    ...
    helmet({
      contentSecurityPolicy: {
        directives: {
          ...
          objectSrc: ["'none'"],
          // Learning Accessories (StarScape embeds) were archived 2026-07-19;
          // no cross-origin frames are embedded, so this stays locked down.
          // If the section returns, re-add the embed origin here.
          frameSrc: ["'none'"],
        },
      },
